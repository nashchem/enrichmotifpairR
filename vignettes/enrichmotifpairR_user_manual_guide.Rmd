...
source("https://raw.github.com/nashchem/enrichmotifpairR/R/visualization.R")
```
...
# get the list of TFs genes, here we have only 14 TFs and plotting them all 
TF_df <- TF_df %>% dplyr::filter(TF_Yes_No == "Yes") %>% dplyr::filter(Name %in% enrich_motifs$TF_name)
